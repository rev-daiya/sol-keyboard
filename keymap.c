...
LAYOUT( \
      ...
      KC_LGUI, ADJ, KC_LALT, RGB_TOG,  RCTL_T(KC_GRV),     KC_SPC, KC_LSFT,     FN, KC_BSPC, KC_ENT,        KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, \
      KC_VOLU, KC_VOLD,          KC_SPC, KC_LSFT,  FN, KC_BSPC,         KC_VOLU, KC_VOLD \
)
